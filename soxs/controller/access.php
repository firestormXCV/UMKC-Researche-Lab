...
function login() {
    ...
    if (count($_POST)==0) require ("./view/layout/layout-lab.tpl");
    else {
        ...
        if(verif_LoginBD($email, $mdp, $profil)) {
            ...
            $nexturl = "http://localhost/UMKC-Researche-Lab/soxs/index.php?controle=homeLab&action=homeLab";
            ...
            require("./view/layout/layout-lab.tpl");
        }
